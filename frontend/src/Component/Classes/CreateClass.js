            ...
            <div className="flex-auto px-4 py-10 pt-0">
              <form className="py-1" onSubmit={formik.handleSubmit}>
                  ...
                  <div className="w-full lg:w-3/12 px-2">
                    <div className="relative w-full mb-3">
                      ...
                      >
                        ...
                        <option value="prenursery_13">Pre Nursery</option>
                        <option value="nursery_14">Nursery</option>
                        <option value="kg_15">KG</option>
                ...
                <div className="flex flex-wrap md:flex-nowrap">
                  <div className="w-full md:w-1/2 flex justify-center flex-wrap border-r-0 md:border-r-2 border-gray-900 pt-5">
                    {subjects
                      ?.filter(
                        (subject) =>
                      ...
                      .map((subject) => (
                        <div key={subject} className="w-1/2 px-4 mb-3 md:mb-0 border-b-2 py-2 border-r-2">
