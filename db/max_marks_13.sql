...
--
-- Table structure for table `max_marks_13`
--

DROP TABLE IF EXISTS `max_marks_13`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `max_marks_13` (
...
--
-- Dumping data for table `max_marks_13`
--

LOCK TABLES `max_marks_13` WRITE;
/*!40000 ALTER TABLE `max_marks_13` DISABLE KEYS */;
INSERT INTO `max_marks_13` VALUES (1,'art',10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10),(2,'english',10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10),(3,'health',10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10),(4,'math',10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10);
/*!40000 ALTER TABLE `max_marks_13` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-05-19 21:30:57
